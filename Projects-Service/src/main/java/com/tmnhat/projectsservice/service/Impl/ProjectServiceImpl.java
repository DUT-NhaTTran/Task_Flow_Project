...
public class ProjectServiceImpl implements ProjectService {
    ...
    public void assignMember(UUID projectId, UUID userId, String roleInProject) {
        try {
            ...
            projectDAO.assignMember(projectId, userId, roleInProject);
        } catch (Exception e) {
    ...
    public void changeProjectOwner(UUID projectId, UUID newOwnerId) {
        try {
            ...
            projectDAO.changeProjectOwner(projectId, newOwnerId);
        } catch (Exception e) {
    ...
    public List<Projects> filterProjectsByStatus(String status) {
        try {
            return projectDAO.filterProjectsByStatus(status);
        } catch (Exception e) {
    ...
    public void favoriteProject(UUID projectId, UUID userId) {
        try {
            projectDAO.favoriteProject(projectId, userId);
        } catch (Exception e) {
            throw new DatabaseException("Error favoriting project: " + e.getMessage());
        }
    }
